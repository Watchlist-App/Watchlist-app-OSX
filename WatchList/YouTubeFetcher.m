...
+ (NSString *)youtubeHTMLForID:(NSString *)ID{
    NSString *iframe = [NSString stringWithFormat:@" <object width=\"640\" height=\"390\"><param name=\"allowScriptAccess\" value=\"always\"></param><embed src=\"https://www.youtube.com/v/%@?version=3&amp;hl=en_US&amp;autoplay=0&amp;rel=0\"type=\"application/x-shockwave-flash\"allowscriptaccess=\"always\"width=\"640\" height=\"390\"></embed></object>",ID];
    return iframe;
}
